...
public final class CancelQueryWithSessionHandle implements Externalizable, Message<CancelQueryWithSessionHandle>, Schema<CancelQueryWithSessionHandle>
{
    ...
    public CancelQueryWithSessionHandle()
    {
    ...
    public Class<CancelQueryWithSessionHandle> typeClass()
    {
    ...
    public boolean isInitialized(CancelQueryWithSessionHandle message)
    {
        return true;
    }

    public void mergeFrom(Input input, CancelQueryWithSessionHandle message) throws IOException
    {
    ...
    public void writeTo(Output output, CancelQueryWithSessionHandle message) throws IOException
    {
