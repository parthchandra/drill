...
public final class OperatorProfile implements Externalizable, Message<OperatorProfile>, Schema<OperatorProfile>
{
    ...
    public OperatorProfile setProcessCPUNanos(long processCPUNanos)
    {
        ...
        for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
        {
            switch(number)
            {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    message.processCPUNanos = input.readInt64();
                    break;
                default:
    ...
    public void writeTo(Output output, OperatorProfile message) throws IOException
    {
        ...
        if(message.processCPUNanos != 0)
            output.writeInt64(10, message.processCPUNanos, false);
    }
    ...
    public String getFieldName(int number)
    {
        switch(number)
        {
            ...
            case 10: return "processCPUNanos";
            default: return null;
        }
    }
    ...
    static
    {
        ...
        __fieldMap.put("processCPUNanos", 10);
    }
