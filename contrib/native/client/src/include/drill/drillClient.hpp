...
class DECLSPEC_DRILL_CLIENT Metadata {
  public:
     ...
     * @param[out] the query handle
     */
    virtual status_t getTables(const std::string& catalogPattern, const std::string& schemaPattern, const std::string& tablePattern, pfnTableMetadataListener listener, void* listenerCtx, QueryHandle_t* qHandle) = 0;
