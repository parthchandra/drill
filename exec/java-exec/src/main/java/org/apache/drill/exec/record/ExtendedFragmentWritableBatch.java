...
public class ExtendedFragmentWritableBatch {
  ...
  private final FragmentWritableBatch fragmentWritableBatch;
  private final QueryFragmentQuery queryFragmentHeader;
  
  private PushDataRequestHeader header;
  ...
  public PushDataRequestHeader getHeader() {
    return this.header;
  }
  
  public ByteBuf[] getBuffers(){
    return fragmentWritableBatch.getBuffers();
  }
  
  public long getByteCount() {
    return fragmentWritableBatch.getByteCount();
  }
}
