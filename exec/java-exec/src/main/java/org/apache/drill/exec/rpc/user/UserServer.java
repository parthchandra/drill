  ...
  protected void handle(UserClientConnection connection, int rpcType, ByteBuf pBody, ByteBuf dBody,
    ...
    case RpcType.GET_CATALOGS_VALUE:
      try {
        ...
        worker.submitCatalogMetadataWork(connection, req, responseSender);
        break;
      } catch (final InvalidProtocolBufferException e) {
    ...
    case RpcType.GET_SCHEMAS_VALUE:
      try {
        ...
        worker.submitSchemasMetadataWork(connection, req, responseSender);
        break;
      } catch (final InvalidProtocolBufferException e) {
    ...
    case RpcType.GET_TABLES_VALUE:
      try {
        ...
        worker.submitTablesMetadataWork(connection, req, responseSender);
        break;
      } catch (final InvalidProtocolBufferException e) {
    ...
    case RpcType.GET_COLUMNS_VALUE:
      try {
        ...
        worker.submitColumnsMetadataWork(connection, req, responseSender);
        break;
      } catch (final InvalidProtocolBufferException e) {
