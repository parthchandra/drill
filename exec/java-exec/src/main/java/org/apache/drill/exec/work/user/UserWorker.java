...
public class UserWorker{
  ...
  public void submitCatalogMetadataWork(UserClientConnection connection, GetCatalogsReq req, ResponseSender sender) {
    bee.addNewWork(new MetadataProvider.CatalogsProvider(connection, bee.getContext(), req, sender));
  }

  public void submitSchemasMetadataWork(UserClientConnection connection, GetSchemasReq req, ResponseSender sender) {
    bee.addNewWork(new MetadataProvider.SchemasProvider(connection, bee.getContext(), req, sender));
  }

  public void submitTablesMetadataWork(UserClientConnection connection, GetTablesReq req, ResponseSender sender) {
    bee.addNewWork(new MetadataProvider.TablesProvider(connection, bee.getContext(), req, sender));
  }

  public void submitColumnsMetadataWork(UserClientConnection connection, GetColumnsReq req, ResponseSender sender) {
    bee.addNewWork(new MetadataProvider.ColumnsProvider(connection, bee.getContext(), req, sender));
  }
