...
public class InsertLocalExchangeVisitor extends BasePrelVisitor<Prel, Void, RuntimeException> {
  private static final DrillSqlOperator SQL_OP_HASH64 = new DrillSqlOperator("hash64", 2, MajorType.getDefaultInstance(), false);
  private static final DrillSqlOperator SQL_OP_CAST_INT = new DrillSqlOperator("castINT", 1, MajorType.getDefaultInstance(), false);
  ...
  public Prel visitExchange(ExchangePrel prel, Void value) throws RuntimeException {
    ...
    if ( isMuxEnabled ) {
      ...
      RexNode hashExpr = rexBuilder.makeCall(SQL_OP_HASH64, firstFieldInputRef);
      ...
      for (int i=1; i<fields.size(); i++) {
        ...
        hashExpr = rexBuilder.makeCall(SQL_OP_HASH64, inputRef, hashExpr);
      }
