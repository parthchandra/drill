...
import org.apache.drill.exec.physical.impl.join.LateralJoinBatchCreator;
...
public class TestUnnestWithLateralCorrectness extends SubOperatorTest {
  ...
  private int addBatchToHyperContainer(List<ValueVector> resultList, RecordBatch inputBatch) {
    int count = 0;
